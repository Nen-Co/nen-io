...
pub const IOPrefetchSystem = struct {
    ...
    // File prefetching
    pub fn prefetchFileData(self: *IOPrefetchSystem, io_layout: *const dod_layout.DODIOLayout, file_index: u32, hint: IOPrefetchHint) void {
    ...
    // Network prefetching
    pub fn prefetchNetworkData(self: *IOPrefetchSystem, io_layout: *const dod_layout.DODIOLayout, network_index: u32, hint: IOPrefetchHint) void {
    ...
    // Buffer prefetching
    pub fn prefetchBufferData(self: *IOPrefetchSystem, io_layout: *const dod_layout.DODIOLayout, buffer_index: u32, hint: IOPrefetchHint) void {
    ...
    // Batch prefetching
    pub fn prefetchBatchData(self: *IOPrefetchSystem, io_layout: *const dod_layout.DODIOLayout, batch_index: u32, hint: IOPrefetchHint) void {
    ...
    pub fn prefetchFilesSIMD(self: *IOPrefetchSystem, io_layout: *const dod_layout.DODIOLayout, file_indices: []const u32, _: IOPrefetchPattern) void {
        if (!self.config.enable_file_prefetch) return;
    ...
    pub fn prefetchIOPattern(self: *IOPrefetchSystem, io_layout: *const dod_layout.DODIOLayout, _pattern: IOPrefetchPattern, indices: []const u32) void {
        switch (_pattern) {
